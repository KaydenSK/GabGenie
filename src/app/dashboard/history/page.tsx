...
const History = async () => {
  ...
  return (
    <div className="mx-5 py-2 ">
      <div className="mt-5 py-6 px4  bg-white dark:bg-black rounded">
        <h2 className="font-medium">Output History</h2>
        
      </div>
      <div className="mt-5 py-6 bg-white dark:bg-[#222831] rounded">
        <Table className="dark:border-white">
          <TableCaption>A list of your ai output history.</TableCaption>
          <TableHeader >
            <TableRow className=" dark:border-b-white  ">
